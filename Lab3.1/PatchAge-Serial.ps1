<# Demo script for SANS 5x7 courses.
    ...
    loop vs. a ForEach -Parallel loop. The script runs a traditional for loop to simulate gathering patch age
    information from multiple hosts. To simulate successful connections to responsive hosts, we make connections
...
$hostlist | ForEach-Object {
    ...
    $results[$hostname] = $patchAge
    #Increment the result counter
    $processedCount = $results.Count

    Write-Verbose "$hostname $patchAge"
